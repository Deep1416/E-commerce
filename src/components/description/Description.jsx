...
const Description = () => {
  return (
    <div className = "my-[120px] mx-[170px]">
        <div className='flex'>
            <div className='flex items-center justify-center text-base font-semibold w-[171px] h-[70px] border boredr-[#d0d0d0]'>
                Description
            </div>
            <div className='bg-[#fbfbfb] flex items-center justify-center text-base font-semibold w-[171px] h-[70px] border boredr-[#d0d0d0] text-[#555]'>
                Reviews (122)
            </div>
        </div>
        <div className='flex flex-col gap-[25px] border border-[#d0d0d0] p-12 pb-[70px]'>
